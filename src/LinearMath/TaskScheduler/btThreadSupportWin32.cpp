...
public:
    ...
    virtual int getNumThreads() const { return m_numThreads; }
...
UINT64 getProcessorTeamMask( const ProcessorInfo& procInfo, int procId )
{
...
int getProcessorTeamIndex( const ProcessorInfo& procInfo, int procId )
{
    UINT64 procMask = UINT64( 1 ) << procId;
    for ( int i = 0; i < procInfo.numTeamMasks; ++i )
    {
